...
class Whiskey(db.Model):
    ...
    def __init__(self,brand,age,rating,flavor,price,user_token, id = ''):
        self.id = self.set_id()
        self.brand = brand
        self.age = age
        self.rating = rating
    ...
    def __repr__(self):
        return f'The following whiskey has been added to your collection: {self.brand}, aged {self.age} years.'
...
class WhiskeySchema(ma.Schema):
    class Meta:
        fields = ['id', 'brand','age','rating','flavor', 'price']
